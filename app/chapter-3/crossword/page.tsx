...
const cells = [
  ...
  // BATUNIGHTSPECTACULER (mendatar 2)
  ...
  // row 5 col 20 = E sudah ada di BATUNIGHTSPECTACULER
  ...
  // BUBUB (menurun 3, dari row 5 col 2)
  // row 5 col 2 = B sudah ada di BATUNIGHTSPECTACULER
  { row: 6, col: 2, letter: "U" },
  { row: 7, col: 2, letter: "B" },
  ...
  // TANJUNGPENYU (menurun 4, dari col 10)
  // row 5 col 10 = T sudah ada di BATUNIGHTSPECTACULER
  ...
  // row 8 col 20 = A sudah ada di KENDARI
  { row: 8, col: 21, letter: "N" },

  // GOLDEN (menurun 5, dari row 8 col 18)
  // row 8 col 18 = G sudah ada di BAYANGKAN
  ...
  // row 9 col 10 = U sudah ada di TANJUNGPENYU
  { row: 9, col: 11, letter: "M" },

  // TELPONIYEN (mendatar 5)
  { row: 12, col: 7, letter: "T", number: 5 },
  { row: 12, col: 8, letter: "E" },
  { row: 12, col: 9, letter: "L" },
  // row 12 col 10 = P sudah ada di TANJUNGPENYU
  ...
  // row 15 col 10 = Y sudah ada di TANJUNGPENYU
...
export default function CrosswordPage() {
  ...
  // ✅ completed hanya true jika SEMUA sel terisi DAN semua benar
  const completed = cells.every((cell) => {
    const key = `${cell.row}-${cell.col}`;
    const val = inputs[key];
    return val !== undefined && val !== "" && val === cell.letter;
  });
  ...
  return (
    <main className="min-h-screen bg-black text-white relative overflow-hidden px-6 py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* BACK BUTTON */}
        <a href="/chapter-3/love-wordle" className="text-sm text-gray-400 hover:text-white transition">
          ← Back to Love Wordle
        </a>
        ...
        <div className="text-center mt-16 mb-20">
          ...
          <h1 className="text-5xl md:text-7xl font-serif italic mb-8">Crossword</h1>
          <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
            only someone who truly knows us can finish this ✨
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start justify-center">
          ...
          <div
            className="relative"
            style={{ width: 22 * CELL, height: 17 * CELL }}
          >
            {cells.map((cell) => {
              const key = `${cell.row}-${cell.col}`;
              const currentValue = inputs[key] || "";
              const isCorrect = currentValue !== "" && currentValue === cell.letter;
              const isWrong = currentValue !== "" && currentValue !== cell.letter;
              ...
              return (
                <div
                  ...
                  className="absolute"
                  style={{
                    left: (cell.col - 1) * CELL,
                    top: (cell.row - 1) * CELL,
                  }}
                >
                  {cell.number && (
                    <span className="absolute top-[2px] left-[4px] text-xs font-semibold text-black z-10">
                      {cell.number}
                    </span>
                  )}
                  <input
                    ...
                    className={`
                      w-[38px] h-[38px] text-center uppercase text-base font-bold
          ...
          <div className="w-full max-w-md space-y-10 lg:pl-8">
            <div>
              <h2 className="text-2xl font-bold mb-6 text-pink-300">Mendatar</h2>
              <div className="space-y-4 text-gray-300">
                <p>1. Dimana tempat ketemu iyen</p>
                <p>2. Kemana jalan jalan terakhir di Malang</p>
                <p>3. Apa istilah untuk bab dari mas dida</p>
                <p>4. Apa istilah untuk mwamwa</p>
                <p>5. Apa yang dilakukan ketika beol</p>
                <p>6. Apa istilah untuk bab dari iyen</p>
                <p>7. Soundtrack di awal halaman ini namanya apa</p>
              </div>
            </div>
            <div>
              <h2 className="text-2xl font-bold mb-6 text-purple-300">Menurun</h2>
              <div className="space-y-4 text-gray-300">
                <p>1. Apa warna bunga yang pernah dikasih ke iyen</p>
                <p>2. Apa nama panggilan buat iyen</p>
                <p>3. Kepada siapa iyen cemburu</p>
                <p>4. Kemana pantai terakhir bersama iyen</p>
                <p>5. Apa ras anjing yang pengen dipelihara</p>
                <p>6. Iyen sekarang lagi dimana</p>
              </div>
            </div>
          </div>
        ...
        {/* ✅ TOMBOL HANYA MUNCUL SAAT SEMUA JAWABAN BENAR */}
        {completed && (
          <div className="mt-24 text-center bg-pink-500/10 border border-pink-400/20 rounded-[40px] p-14 animate-pulse">
            <div className="text-6xl mb-6">💌</div>
            <h2 className="text-4xl font-serif italic mb-8">
              You completed every piece of us.
            </h2>
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto">
              every joke, every memory, every tiny detail...
              somehow you still remember all of it.
            </p>
            
              href="/chapter-3/final-reveal"
              className="inline-flex items-center justify-center mt-10 px-8 py-4 rounded-full bg-white text-black text-sm font-semibold hover:scale-105 transition-all duration-300"
            >
              Open Final Surprise ✨
            </a>
          </div>
